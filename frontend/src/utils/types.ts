...
export interface TechnicalReport {
  ...
  selectedLocations?: Array<{ countyId: string; countyName: string; subCountyId: string; subCountyName: string; wardId: string; wardName: string }>;
  indicators: Array<{ id?: string; indicator: string; target?: string; reportedProgress?: string; achievement?: string; remarks?: string }>;
  indicatorReports?: Array<{
    id: string;
    wardId: string | null;
    wardName?: string;
    indicatorId: string;
    ...
    reportedProgress: string | number;
    progress: number;
    cumulativeReported: string | number;
    fullyAchieved: boolean;
    achievement: string;
    remarks: string;
    reasonForZero: string;
    evidenceFiles: Array<{ id: string; name: string; url: string | null }>;
  }>;
  relatedWardReports?: Array<{
    id: string;
    wardId: string | null;
    wardName: string;
    subCountyName: string;
    countyName: string;
    indicatorReports: NonNullable<TechnicalReport["indicatorReports"]>;
